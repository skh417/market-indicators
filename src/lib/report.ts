...
입력 JSON은 미국·한국 증시 지표 10종의 현재값과 압축 통계입니다.
...
분석 원칙:
1. 지표를 네 축으로 묶어 교차 해석할 것: 밸류에이션(버핏 지수·CAPE), 심리(VIX·VKOSPI·공포탐욕), 유동성·신용(HY 스프레드·NFCI·원/달러), 한국 경기(수출 증가율·코스피 투자자별 수급).
...
3. '심리와 유동성' — 미국·한국 변동성과 공포탐욕, 신용스프레드·금융여건·원/달러 흐름.
4. '한국 경기와 수급' — 수출 증가율과 외국인·기관·개인 수급 흐름.
